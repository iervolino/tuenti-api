 ...
 * @version    1.0.0
 *
 * @method int getSender() getSender()
 * @method void setSender() setSender(int $sender)
 * @method int getTime() getTime()
 * @method void setTime() setTime(int $time)
 * @method boolean getIsRead() getIsRead()
 * @method void setIsRead() setIsRead(boolean $isRead)
...
{
  /**
   * Get the sender profile object
   * @return Profile
   */
  public function getSenderProfile()
  {
    return $this->getConnection()->getUserProfile(parent::getSender());
  }
